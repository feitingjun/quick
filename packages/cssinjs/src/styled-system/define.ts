...
export type ChainablePath<T, Prefix extends string = ''> = {
...
// 主题类型
export interface ThemeDefine<TLength = TLengthStyledSystem> {
...
export type RequiredTheme = Required<ThemeDefine>

// 属性值可以使用数组或者按照breakpoints设置
export type ResponsiveValue<T, ThemeType extends ThemeDefine = Theme> =
  | T
  | null
  | Array<T | null>
  | `{${ChainablePath<Theme>}}`
...
// 从传入的主题泛型中获取指定属性实际的类型

export type ThemeValue<K extends keyof ThemeType, ThemeType, TVal = any> = NonNullable<
  ThemeType[K]
> extends TVal[]
  ? number
 ...
 */
export interface SpaceProps<ThemeType extends ThemeDefine = Theme, TVal = number> {
...
export interface TextAlignProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface FontStyleProps<ThemeType extends ThemeDefine = Theme> {
  /**
 ...
 * - Array values are converted into responsive values.
 */
export interface TypographyProps<ThemeType extends ThemeDefine = Theme>
 ...
 * Flexbox
 */
export interface AlignItemsProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface AlignContentProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface JustifyItemsProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface JustifyContentProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface FlexWrapProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface FlexDirectionProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface FlexProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.Flex> {
  /**
...
export interface JustifySelfProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface AlignSelfProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface OrderProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface FlexGrowProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface FlexShrinkProps<ThemeType extends ThemeDefine = Theme> {
  /**
 ...
 * - Array values are converted into responsive values.
 */
export interface FlexboxProps<ThemeType extends ThemeDefine = Theme>
...
export interface GridColumnProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface GridRowProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface GridAutoFlowProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface GridTemplateAreasProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface GridAreaProps<ThemeType extends ThemeDefine = Theme> {
  /**
 ...
 * - Array values are converted into responsive values.
 */
export interface GridProps<ThemeType extends ThemeDefine = Theme>
 ...
 * - Array values are converted into responsive values.
 */
export interface LayoutProps<ThemeType extends ThemeDefine = Theme>
...
export interface ShadowProps<ThemeType extends ThemeDefine = Theme>
  extends BoxShadowProps<ThemeType>,
    TextShadowProps<ThemeType> {}

export interface OpacityProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface OverflowProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface BackgroundImageProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface BackgroundRepeatProps<ThemeType extends ThemeDefine = Theme> {
  /**
...
export interface TopProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.Top<number>> {
  /**
...
export interface RightProps<
  ThemeType extends ThemeDefine = Theme,
  TVal = CSS.Property.Right<number>
> {
  /**
...
export interface BottomProps<
  ThemeType extends ThemeDefine = Theme,
  TVal = CSS.Property.Bottom<number>
> {
  /**
...
export interface PositionProps<ThemeType extends ThemeDefine = Theme>
