...
interface BorderTopProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'borders', ThemeType>> {
    /**
...
interface BorderRightProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'borders', ThemeType>> {
    /**
...
interface BorderBottomProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'borders', ThemeType>> {
    /**
...
interface BorderLeftProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'borders', ThemeType>> {
    /**
