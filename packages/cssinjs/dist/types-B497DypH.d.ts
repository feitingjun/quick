...
import { NativeCSS } from './styled-system/native-css.js';
import { CustomPseudos } from './custom-pseudos.js';

interface Theme {
}
type ChainablePath<T, Prefix extends string = ''> = {
    [K in keyof T]: T[K] extends object ? ChainablePath<T[K], `${Prefix}${K & string}.`> : `${Prefix}${K & string}`;
}[keyof T];
...
type ResponsiveValue<T, ThemeType extends ThemeDefine = Theme> = T | null | Array<T | null> | `{${ChainablePath<Theme>}}` | {
    [key in (ThemeValue<'breakpoints', ThemeType> & string) | number]?: T | `{${ChainablePath<Theme>}}`;
};
type ThemeValue<K extends keyof ThemeType, ThemeType, TVal = any> = NonNullable<ThemeType[K]> extends TVal[] ? number : NonNullable<ThemeType[K]> extends Record<infer E, TVal> ? E : NonNullable<ThemeType[K]> extends ObjectOrArray<infer F> ? F : never;
/**
 ...
 * Color
 */
interface TextColorProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'colors', ThemeType>> {
    /**
...
interface BackgroundColorProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'colors', ThemeType>> {
    /**
     * The color utility parses a component's `color` and `bg` props and converts them into CSS declarations.
     * By default the raw value of the prop is returned.
     *
...
interface ColorProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'colors', ThemeType>> extends TextColorProps<ThemeType, TVal>, BackgroundColorProps<ThemeType, TVal>, OpacityProps {
}
/**
 * Typography
 */
interface FontSizeProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'fontSizes', ThemeType>> {
    /**
...
interface FontWeightProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'fontWeights', ThemeType>> {
    fontWeight?: ResponsiveValue<TVal | CSS.Property.FontWeight, ThemeType> | undefined;
}
interface LineHeightProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'lineHeights', ThemeType>> {
    /**
...
interface LetterSpacingProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'letterSpacings', ThemeType>> {
    /**
 ...
 * - Array values are converted into responsive values.
 */
interface TypographyProps<ThemeType extends ThemeDefine = Theme> extends FontFamilyProps<ThemeType>, FontSizeProps<ThemeType>, FontWeightProps<ThemeType>, LineHeightProps<ThemeType>, LetterSpacingProps<ThemeType>, FontStyleProps<ThemeType>, TextAlignProps<ThemeType> {
}
/**
 * Layout
 */
interface CursorProps<ThemeType extends ThemeDefine = Theme> {
...
interface WidthProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'sizes', ThemeType>> {
    /**
...
interface MaxWidthProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'sizes', ThemeType>> {
    /**
...
interface MinWidthProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'sizes', ThemeType>> {
    /**
...
interface HeightProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'sizes', ThemeType>> {
    /**
...
interface MaxHeightProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'sizes', ThemeType>> {
    /**
...
interface MinHeightProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'sizes', ThemeType>> {
    /**
...
interface SizeProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'sizes', ThemeType>> {
    sizes?: ResponsiveValue<TVal | CSS.Property.Height, ThemeType> | undefined;
}
interface VerticalAlignProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.VerticalAlign> {
    /**
...
interface GridColumnGapProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.ColumnGap<number>> {
    /**
...
interface GridRowGapProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.RowGap<number>> {
    /**
...
interface GridAutoColumnsProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.GridAutoColumns<number>> {
    /**
...
interface GridAutoRowsProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.GridAutoRows<number>> {
    /**
...
interface GridTemplateColumnsProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.GridTemplateColumns<number>> {
    /**
...
interface GridTemplateRowsProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.GridTemplateRows<number>> {
    /**
 ...
 * - Array values are converted into responsive values.
 */
interface GridProps<ThemeType extends ThemeDefine = Theme> extends GridGapProps<ThemeType>, GridColumnGapProps<ThemeType>, GridRowGapProps<ThemeType>, GridColumnProps<ThemeType>, GridRowProps<ThemeType>, GridAutoFlowProps<ThemeType>, GridAutoColumnsProps<ThemeType>, GridAutoRowsProps<ThemeType>, GridTemplateColumnsProps<ThemeType>, GridTemplateRowsProps<ThemeType>, GridTemplateAreasProps<ThemeType>, GridAreaProps<ThemeType> {
}
/**
 ...
 * - Array values are converted into responsive values.
 */
interface LayoutProps<ThemeType extends ThemeDefine = Theme> extends WidthProps<ThemeType>, HeightProps<ThemeType>, MinWidthProps<ThemeType>, MinHeightProps<ThemeType>, MaxWidthProps<ThemeType>, MaxHeightProps<ThemeType>, DisplayProps<ThemeType>, VerticalAlignProps<ThemeType>, SizeProps<ThemeType>, OverflowProps<ThemeType>, CursorProps<ThemeType> {
}
/**
 * Borders
 */
interface BorderWidthProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'borderWidths', ThemeType>> {
    /**
...
interface BorderStyleProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'borderStyles', ThemeType>> {
    /**
...
interface BorderColorProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'colors', ThemeType>> {
    /**
...
interface BorderTopProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.BorderTop<number>> {
    /**
...
interface BorderRightProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.BorderRight<number>> {
    /**
...
interface BorderBottomProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.BorderBottom<number>> {
    /**
...
interface BorderLeftProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.BorderLeft<number>> {
    /**
...
interface BorderRadiusProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'radii', ThemeType>> {
    /**
     ...
     */
    borderTopLeftRadius?: ResponsiveValue<TVal | CSS.Property.BorderTopLeftRadius, ThemeType> | undefined;
    /**
     * The border-top-right-radius CSS property rounds the top-right corner of an element.
     *
     * [MDN reference](https://developer.mozilla.org/en-US/docs/Web/CSS/border-top-right-radius)
     */
    borderTopRightRadius?: ResponsiveValue<TVal | CSS.Property.BorderTopRightRadius, ThemeType> | undefined;
    /**
     * The border-bottom-left-radius CSS property rounds the bottom-left corner of an element.
     *
     * [MDN reference](https://developer.mozilla.org/en-US/docs/Web/CSS/border-bottom-left-radius)
     */
    borderBottomLeftRadius?: ResponsiveValue<TVal | CSS.Property.BorderBottomLeftRadius, ThemeType> | undefined;
    /**
     * The border-bottom-right-radius CSS property rounds the bottom-right corner of an element.
     *
     * [MDN reference](https://developer.mozilla.org/en-US/docs/Web/CSS/border-bottom-right-radius)
     */
    borderBottomRightRadius?: ResponsiveValue<TVal | CSS.Property.BorderBottomRightRadius, ThemeType> | undefined;
}
interface BorderProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'borders', ThemeType>> extends BorderWidthProps<ThemeType>, BorderStyleProps<ThemeType>, BorderColorProps<ThemeType>, BorderRadiusProps<ThemeType>, BorderTopProps<ThemeType>, BorderRightProps<ThemeType>, BorderBottomProps<ThemeType>, BorderLeftProps<ThemeType> {
    /**
...
interface BoxShadowProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'shadows', ThemeType>> {
    /**
...
interface TextShadowProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'shadows', ThemeType>> {
    /**
...
interface ShadowProps<ThemeType extends ThemeDefine = Theme> extends BoxShadowProps<ThemeType>, TextShadowProps<ThemeType> {
}
...
interface BackgroundSizeProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.BackgroundSize<number>> {
    /**
...
interface BackgroundPositionProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.BackgroundPosition<number>> {
    /**
...
interface BackgroundProps<ThemeType extends ThemeDefine = Theme, TVal = CSS.Property.Background<number>> extends BackgroundImageProps<ThemeType>, BackgroundSizeProps<ThemeType>, BackgroundPositionProps<ThemeType>, BackgroundRepeatProps<ThemeType> {
    /**
 ...
 * Position
 */
interface ZIndexProps<ThemeType extends ThemeDefine = Theme, TVal = ThemeValue<'zIndices', ThemeType>> {
    /**
...
interface PositionProps<ThemeType extends ThemeDefine = Theme> extends ZIndexProps<ThemeType>, TopProps<ThemeType>, RightProps<ThemeType>, BottomProps<ThemeType>, LeftProps<ThemeType> {
    /**
...
interface AnimationProps<ThemeType extends ThemeDefine = Theme> {
    /**
    ...
    animationTimingFunction?: ResponsiveValue<CSS.Property.AnimationTimingFunction, ThemeType> | undefined;
    animationDelay?: ResponsiveValue<CSS.Property.AnimationDelay, ThemeType> | undefined;
    animationIterationCount?: ResponsiveValue<CSS.Property.AnimationIterationCount, ThemeType> | undefined;
...
/**css属性 */
type CSSProperties<T extends Theme = Theme> = ColorProps<T> & SpaceProps<T> & LayoutProps<T> & FlexboxProps<T> & BorderProps<T> & PositionProps<T> & ShadowProps<T> & TypographyProps<T> & BackgroundProps<T> & GridProps<T> & OpacityProps<T> & AnimationProps;
/**css变量 */
type CSSVars<T extends Theme = Theme> = {
    [key: `--${string}`]: ValueOf<CSSProperties<T>>;
};
/**css原生伪类 */
type SystemPseudoStyles<T extends Theme = Theme> = {
    [K in CSS.Pseudos]?: CSSProperties<T> & CSSVars<T> & {
        content: `"${string}"`;
    };
} & {
    [K in `${string}${CSS.Pseudos}`]?: CSSProperties<T> & CSSVars<T> & {
        content: `"${string}"`;
    };
};
/**自定义伪类 */
type CustomPseudoStyles<T extends Theme = Theme> = {
    [K in CustomPseudos]?: CSSProperties<T> & CSSVars<T> & {
        content: `"${string}"`;
    };
};
/**其他属性 */
type CSSOthersStyles<T extends Theme = Theme> = {
    [propertiesName: string]: SxProps<T> | string | number | null;
};
/**基础样式 */
interface BaseStyles<T extends Theme = Theme> extends CSSProperties, CSSVars, SystemPseudoStyles<T>, CustomPseudoStyles<T> {
}
/**排除自定义样式的原生css属性 */
interface NativeStyles<T extends Theme = Theme> extends Omit<NativeCSS, keyof BaseStyles<T>> {
}
/**组件props支持的样式属性 */
type ComponentCssStyles<T extends Theme = Theme> = CSSProperties<T> & CustomPseudoStyles<T>;
/**组件sx和styled接受的样式属性 */
type SxProps<T extends Theme = Theme> = (NativeStyles<T> & BaseStyles<T>) | CSSOthersStyles<T>;

export type { FlexboxProps as $, AlignItemsProps as A, BaseStyles as B, CSSProperties as C, DisplayProps as D, AlignContentProps as E, FontSizeProps as F, JustifyContentProps as G, HeightProps as H, FlexWrapProps as I, JustifyItemsProps as J, FlexBasisProps as K, LineHeightProps as L, MaxWidthProps as M, NativeStyles as N, ObjectOrArray as O, FlexDirectionProps as P, FlexProps as Q, RequiredTheme as R, SystemPseudoStyles as S, Theme as T, JustifySelfProps as U, ValueOf as V, WidthProps as W, AlignSelfProps as X, OrderProps as Y, FlexGrowProps as Z, FlexShrinkProps as _, CSSVars as a, GridGapProps as a0, GridColumnGapProps as a1, GridRowGapProps as a2, GridColumnProps as a3, GridRowProps as a4, GridAutoFlowProps as a5, GridAutoColumnsProps as a6, GridAutoRowsProps as a7, GridTemplateColumnsProps as a8, GridTemplateRowsProps as a9, BottomProps as aA, LeftProps as aB, PositionProps as aC, AnimationProps as aD, GridTemplateAreasProps as aa, GridAreaProps as ab, GridProps as ac, LayoutProps as ad, BorderWidthProps as ae, BorderStyleProps as af, BorderColorProps as ag, BorderTopProps as ah, BorderRightProps as ai, BorderBottomProps as aj, BorderLeftProps as ak, BorderRadiusProps as al, BorderProps as am, BoxShadowProps as an, TextShadowProps as ao, ShadowProps as ap, OpacityProps as aq, OverflowProps as ar, BackgroundImageProps as as, BackgroundSizeProps as at, BackgroundPositionProps as au, BackgroundRepeatProps as av, BackgroundProps as aw, ZIndexProps as ax, TopProps as ay, RightProps as az, CustomPseudoStyles as b, CSSOthersStyles as c, ComponentCssStyles as d, SxProps as e, ChainablePath as f, TLengthStyledSystem as g, ThemeDefine as h, ResponsiveValue as i, ThemeValue as j, SpaceProps as k, TextColorProps as l, BackgroundColorProps as m, ColorProps as n, FontFamilyProps as o, FontWeightProps as p, TextAlignProps as q, FontStyleProps as r, LetterSpacingProps as s, TypographyProps as t, CursorProps as u, MinWidthProps as v, MaxHeightProps as w, MinHeightProps as x, SizeProps as y, VerticalAlignProps as z };
