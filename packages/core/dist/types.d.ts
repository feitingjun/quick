...
/**路由清单 */
type RouteManifest = Record<string, RouteManifestObject>;
/**使类型的某一个属性可选 */
...
/**插件运行时类型 */
type Runtime = (options: RuntimeOptions) => void;
/**quick插件配置 */
...
/**插件addWatch参数 */
type PluginWatcher = (eventName: 'add' | 'addDir' | 'change' | 'unlink' | 'unlinkDir', path: string, stats?: Stats) => void;
/**插件参数 */
...
export type { AddFileOptions, MakePropertyOptional, Plugin, PluginOptions, PluginWatcher, Provider, QuickConfig, RouteManifest, RouteManifestObject, Runtime, RuntimeOptions, Wrapper };
